...
urlpatterns = [
    ...
    path(
        "reset_password",
        PasswordResetView.as_view(template_name="user/auth/password_reset.html"),
        name="password_reset",
    ),
    path(
        "reset_password_done",
    ...
    path(
        "profile/images/set_main_image/<int:user_image_id>/",
        views.set_main_image,
        name="set_main_image",
    ),
    path(
        "profile/images/delete_user_image/<int:user_image_id>/",
        views.delete_user_image,
